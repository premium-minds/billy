...
public class ADSimpleInvoiceIssuingHandler
        extends ADGenericInvoiceIssuingHandler<ADSimpleInvoiceEntity, ADIssuingParams>
{

    private final DAOADSimpleInvoice daoSimpleInvoice;

    @Inject
    public ADSimpleInvoiceIssuingHandler(DAOInvoiceSeries daoInvoiceSeries, DAOADSimpleInvoice daoSimpleInvoice) {
        super(daoInvoiceSeries);
        this.daoSimpleInvoice = daoSimpleInvoice;
    }

    @Override
    public ADSimpleInvoiceEntity issue(ADSimpleInvoiceEntity document, ADIssuingParams parameters)
