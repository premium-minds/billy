...
public class ADSimpleInvoiceTemplateBundle extends ADAbstractTemplateBundle {

    public ADSimpleInvoiceTemplateBundle(String logoImagePath, InputStream xsltFileStream) {
