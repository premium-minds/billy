...
public class ADCreditReceiptTemplateBundle extends ADAbstractTemplateBundle {

    public ADCreditReceiptTemplateBundle(String logoImagePath, InputStream xsltFileStream) {
