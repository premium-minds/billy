...
public class DAOADProductImpl extends DAOProductImpl implements DAOADProduct {

    @Inject
    public DAOADProductImpl(Provider<EntityManager> emProvider) {
        super(emProvider);
    }

    @Override
    public ADProductEntity getEntityInstance() {
        return new JPAADProductEntity();
    }

    @Override
    protected Class<JPAADProductEntity> getEntityClass() {
        return JPAADProductEntity.class;
    }
