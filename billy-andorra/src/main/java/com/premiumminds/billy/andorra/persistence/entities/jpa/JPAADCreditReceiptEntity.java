...
public class JPAADCreditReceiptEntity extends JPAADGenericInvoiceEntity implements ADCreditReceiptEntity {
    ...
    public List<ADCreditReceiptEntry> getEntries() {
        return (List<ADCreditReceiptEntry>) super.getEntries();
    }
}
