...
public interface DAOADCreditReceipt extends AbstractDAOADGenericInvoice<ADCreditReceiptEntity> {

    List<ADCreditReceipt> findByReferencedDocument(StringID<Business> uidCompany, StringID<GenericInvoice> uidInvoice);
