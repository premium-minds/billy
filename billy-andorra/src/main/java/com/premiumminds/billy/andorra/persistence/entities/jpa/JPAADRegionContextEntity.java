...
public class JPAADRegionContextEntity extends JPAContextEntity implements ADRegionContextEntity {

    private static final long serialVersionUID = 1L;

    public JPAADRegionContextEntity() {
    }

    @Override
    public ADRegionContext getParentContext() {
        return (ADRegionContext) super.getParentContext();
    }
