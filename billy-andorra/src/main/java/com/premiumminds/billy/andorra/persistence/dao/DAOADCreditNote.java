...
public interface DAOADCreditNote extends AbstractDAOADGenericInvoice<ADCreditNoteEntity> {

    List<ADCreditNote> findByReferencedDocument(StringID<Business> uidCompany, StringID<GenericInvoice> uidInvoice);
