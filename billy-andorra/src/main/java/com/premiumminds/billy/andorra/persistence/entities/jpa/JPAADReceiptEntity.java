...
public class JPAADReceiptEntity extends JPAADGenericInvoiceEntity implements ADReceiptEntity {

    private static final long serialVersionUID = 1L;

    @SuppressWarnings("unchecked")
    @Override
    public List<ADReceiptEntry> getEntries() {
        return (List<ADReceiptEntry>) super.getEntries();
    }
