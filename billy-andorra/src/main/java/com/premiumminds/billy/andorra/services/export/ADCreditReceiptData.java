...
public class ADCreditReceiptData extends GenericInvoiceData {

    private final List<ADCreditReceiptEntryData> entries;

    public ADCreditReceiptData(
        final String number,
        final Date date,
        ...
        final List<ADCreditReceiptEntryData> entries,
    ...
    @Override
    public List<ADCreditReceiptEntryData> getEntries() {
        return this.entries;
    }
