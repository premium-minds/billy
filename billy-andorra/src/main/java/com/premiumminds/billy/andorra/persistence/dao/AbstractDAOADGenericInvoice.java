...
public interface AbstractDAOADGenericInvoice<T extends ADGenericInvoiceEntity> extends AbstractDAOGenericInvoice<T> {

    public T findByNumber(StringID<Business> uidBusiness, String number);
