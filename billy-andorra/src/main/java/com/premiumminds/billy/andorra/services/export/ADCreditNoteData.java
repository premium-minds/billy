...
public class ADCreditNoteData extends GenericInvoiceData {

    private final List<ADCreditNoteEntryData> entries;

    public ADCreditNoteData(
        final String number,
        ...
        final List<ADCreditNoteEntryData> entries,
    ...
    @Override
    public List<ADCreditNoteEntryData> getEntries() {
        return this.entries;
    }
