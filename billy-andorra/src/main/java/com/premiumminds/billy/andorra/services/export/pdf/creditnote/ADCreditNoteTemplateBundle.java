...
public class ADCreditNoteTemplateBundle extends ADAbstractTemplateBundle {

    public ADCreditNoteTemplateBundle(String logoImagePath, InputStream xsltFileStream) {
