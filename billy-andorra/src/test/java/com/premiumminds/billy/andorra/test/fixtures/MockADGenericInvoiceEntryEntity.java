...
public class MockADGenericInvoiceEntryEntity extends MockGenericInvoiceEntryEntity
        implements ADGenericInvoiceEntryEntity
{

    private static final long serialVersionUID = 1L;

    public MockADGenericInvoiceEntryEntity() {
