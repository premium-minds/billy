...
public class MockADCreditNoteEntity extends MockGenericInvoiceEntity implements ADCreditNoteEntity {
    ...
    @Override
    public List<ADCreditNoteEntry> getEntries() {
        return (List<ADCreditNoteEntry>) (List<?>) super.getEntries();
    }
