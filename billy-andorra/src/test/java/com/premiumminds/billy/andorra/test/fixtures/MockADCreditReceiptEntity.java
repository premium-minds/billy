...
public class MockADCreditReceiptEntity extends MockGenericInvoiceEntity implements ADCreditReceiptEntity {
    ...
    public MockADCreditReceiptEntity() {
    ...
    @Override
    public List<ADCreditReceiptEntry> getEntries() {
        return (List<ADCreditReceiptEntry>) (List<?>) super.getEntries();
    }
