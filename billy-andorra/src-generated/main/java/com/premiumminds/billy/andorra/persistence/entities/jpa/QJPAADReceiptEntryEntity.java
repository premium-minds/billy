...
/**
 * QJPAADReceiptEntryEntity is a Querydsl query type for JPAADReceiptEntryEntity
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QJPAADReceiptEntryEntity extends EntityPathBase<JPAADReceiptEntryEntity> {

    private static final long serialVersionUID = -2031605406L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QJPAADReceiptEntryEntity jPAADReceiptEntryEntity = new QJPAADReceiptEntryEntity("jPAADReceiptEntryEntity");
    ...
    public QJPAADReceiptEntryEntity(String variable) {
        this(JPAADReceiptEntryEntity.class, forVariable(variable), INITS);
    }

    public QJPAADReceiptEntryEntity(Path<? extends JPAADReceiptEntryEntity> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QJPAADReceiptEntryEntity(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QJPAADReceiptEntryEntity(PathMetadata metadata, PathInits inits) {
        this(JPAADReceiptEntryEntity.class, metadata, inits);
    }

    public QJPAADReceiptEntryEntity(Class<? extends JPAADReceiptEntryEntity> type, PathMetadata metadata, PathInits inits) {
