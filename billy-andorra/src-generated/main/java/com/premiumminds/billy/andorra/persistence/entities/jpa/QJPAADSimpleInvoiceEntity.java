...
/**
 * QJPAADSimpleInvoiceEntity is a Querydsl query type for JPAADSimpleInvoiceEntity
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QJPAADSimpleInvoiceEntity extends EntityPathBase<JPAADSimpleInvoiceEntity> {

    private static final long serialVersionUID = -1494763079L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QJPAADSimpleInvoiceEntity jPAADSimpleInvoiceEntity = new QJPAADSimpleInvoiceEntity("jPAADSimpleInvoiceEntity");

    public final QJPAADInvoiceEntity _super;
    ...
    public final EnumPath<com.premiumminds.billy.andorra.services.entities.ADSimpleInvoice.CLIENTTYPE> clientType = createEnum("clientType", com.premiumminds.billy.andorra.services.entities.ADSimpleInvoice.CLIENTTYPE.class);
    ...
    //inherited
    public final ListPath<com.premiumminds.billy.andorra.services.entities.ADInvoiceEntry, SimplePath<com.premiumminds.billy.andorra.services.entities.ADInvoiceEntry>> entries;
    ...
    //inherited
    public final ListPath<com.premiumminds.billy.andorra.services.entities.ADPayment, SimplePath<com.premiumminds.billy.andorra.services.entities.ADPayment>> payments;
    ...
    public QJPAADSimpleInvoiceEntity(String variable) {
        this(JPAADSimpleInvoiceEntity.class, forVariable(variable), INITS);
    }

    public QJPAADSimpleInvoiceEntity(Path<? extends JPAADSimpleInvoiceEntity> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QJPAADSimpleInvoiceEntity(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QJPAADSimpleInvoiceEntity(PathMetadata metadata, PathInits inits) {
        this(JPAADSimpleInvoiceEntity.class, metadata, inits);
    }

    public QJPAADSimpleInvoiceEntity(Class<? extends JPAADSimpleInvoiceEntity> type, PathMetadata metadata, PathInits inits) {
        super(type, metadata, inits);
        this._super = new QJPAADInvoiceEntity(type, metadata, inits);
