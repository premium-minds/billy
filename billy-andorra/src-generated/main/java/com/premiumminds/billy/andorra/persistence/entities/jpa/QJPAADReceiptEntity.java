...
/**
 * QJPAADReceiptEntity is a Querydsl query type for JPAADReceiptEntity
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QJPAADReceiptEntity extends EntityPathBase<JPAADReceiptEntity> {

    private static final long serialVersionUID = -986585770L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QJPAADReceiptEntity jPAADReceiptEntity = new QJPAADReceiptEntity("jPAADReceiptEntity");
    ...
    public final ListPath<com.premiumminds.billy.andorra.services.entities.ADReceiptEntry, SimplePath<com.premiumminds.billy.andorra.services.entities.ADReceiptEntry>> entries = this.<com.premiumminds.billy.andorra.services.entities.ADReceiptEntry, SimplePath<com.premiumminds.billy.andorra.services.entities.ADReceiptEntry>>createList("entries", com.premiumminds.billy.andorra.services.entities.ADReceiptEntry.class, SimplePath.class, PathInits.DIRECT2);
    ...
    public QJPAADReceiptEntity(String variable) {
        this(JPAADReceiptEntity.class, forVariable(variable), INITS);
    }

    public QJPAADReceiptEntity(Path<? extends JPAADReceiptEntity> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QJPAADReceiptEntity(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QJPAADReceiptEntity(PathMetadata metadata, PathInits inits) {
        this(JPAADReceiptEntity.class, metadata, inits);
    }

    public QJPAADReceiptEntity(Class<? extends JPAADReceiptEntity> type, PathMetadata metadata, PathInits inits) {
