...
/**
 * QJPAADCreditNoteEntity is a Querydsl query type for JPAADCreditNoteEntity
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QJPAADCreditNoteEntity extends EntityPathBase<JPAADCreditNoteEntity> {

    private static final long serialVersionUID = 1932271443L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QJPAADCreditNoteEntity jPAADCreditNoteEntity = new QJPAADCreditNoteEntity("jPAADCreditNoteEntity");
    ...
    public final ListPath<com.premiumminds.billy.andorra.services.entities.ADCreditNoteEntry, SimplePath<com.premiumminds.billy.andorra.services.entities.ADCreditNoteEntry>> entries = this.<com.premiumminds.billy.andorra.services.entities.ADCreditNoteEntry, SimplePath<com.premiumminds.billy.andorra.services.entities.ADCreditNoteEntry>>createList("entries", com.premiumminds.billy.andorra.services.entities.ADCreditNoteEntry.class, SimplePath.class, PathInits.DIRECT2);
    ...
    public QJPAADCreditNoteEntity(String variable) {
        this(JPAADCreditNoteEntity.class, forVariable(variable), INITS);
    }

    public QJPAADCreditNoteEntity(Path<? extends JPAADCreditNoteEntity> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QJPAADCreditNoteEntity(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QJPAADCreditNoteEntity(PathMetadata metadata, PathInits inits) {
        this(JPAADCreditNoteEntity.class, metadata, inits);
    }

    public QJPAADCreditNoteEntity(Class<? extends JPAADCreditNoteEntity> type, PathMetadata metadata, PathInits inits) {
