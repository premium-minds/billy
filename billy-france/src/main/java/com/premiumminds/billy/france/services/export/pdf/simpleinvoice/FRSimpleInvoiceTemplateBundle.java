...
public class FRSimpleInvoiceTemplateBundle extends FRAbstractTemplateBundle {

    public FRSimpleInvoiceTemplateBundle(String logoImagePath, InputStream xsltFileStream) {
