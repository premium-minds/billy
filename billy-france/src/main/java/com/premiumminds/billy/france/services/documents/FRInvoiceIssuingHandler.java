...
public class FRInvoiceIssuingHandler extends FRGenericInvoiceIssuingHandler<FRInvoiceEntity, FRIssuingParams> {

    private final DAOFRInvoice daoInvoice;

    @Inject
    public FRInvoiceIssuingHandler(DAOInvoiceSeries daoInvoiceSeries, DAOFRInvoice daoInvoice) {
        super(daoInvoiceSeries);
        this.daoInvoice = daoInvoice;
    }

    @Override
    public FRInvoiceEntity issue(FRInvoiceEntity document, FRIssuingParams parameters) throws DocumentIssuingException {
