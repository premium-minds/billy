...
public interface FRManualInvoiceBuilder<TBuilder extends FRManualInvoiceBuilder<TBuilder, TEntry, TDocument>, TEntry extends FRGenericInvoiceEntry, TDocument extends FRGenericInvoice>
        extends FRGenericInvoiceBuilder<TBuilder, TEntry, TDocument> {
