...
public class FRCreditNoteData extends GenericInvoiceData {
    ...
    private final List<FRCreditNoteEntryData> entries;

    public FRCreditNoteData(String number, Date date, Date settlementDate, List<PaymentData> payments,
            CostumerData customer, BusinessData business, List<FRCreditNoteEntryData> entries, BigDecimal taxAmount,
    ...
    @Override
    public List<FRCreditNoteEntryData> getEntries() {
        return this.entries;
    }
