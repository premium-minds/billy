...
public class FRCreditNoteBuilderImpl<TBuilder extends FRCreditNoteBuilderImpl<TBuilder, TEntry, TDocument>, TEntry extends FRCreditNoteEntry, TDocument extends FRCreditNote>
        extends FRGenericInvoiceBuilderImpl<TBuilder, TEntry, TDocument>
        implements FRCreditNoteBuilder<TBuilder, TEntry, TDocument> {

    protected static final Localizer LOCALIZER = new Localizer("com/premiumminds/billy/core/i18n/FieldNames");

    public <TDAO extends AbstractDAOFRGenericInvoice<? extends TDocument>> FRCreditNoteBuilderImpl(TDAO daoFRCreditNote,
