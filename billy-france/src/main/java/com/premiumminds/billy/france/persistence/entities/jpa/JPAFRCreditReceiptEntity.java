...
public class JPAFRCreditReceiptEntity extends JPAFRGenericInvoiceEntity implements FRCreditReceiptEntity {
    ...
    public List<FRCreditReceiptEntry> getEntries() {
        return (List<FRCreditReceiptEntry>) super.getEntries();
    }
}
