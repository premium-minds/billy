...
public class DAOFRInvoiceEntryImpl
        extends AbstractDAOFRGenericInvoiceEntryImpl<FRInvoiceEntryEntity, JPAFRInvoiceEntryEntity>
        implements DAOFRInvoiceEntry {

    @Inject
    public DAOFRInvoiceEntryImpl(Provider<EntityManager> emProvider) {
        super(emProvider);
    }

    @Override
    public FRInvoiceEntryEntity getEntityInstance() {
