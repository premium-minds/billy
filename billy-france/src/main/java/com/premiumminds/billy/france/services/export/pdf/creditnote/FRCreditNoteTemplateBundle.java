...
public class FRCreditNoteTemplateBundle extends FRAbstractTemplateBundle {

    public FRCreditNoteTemplateBundle(String logoImagePath, InputStream xsltFileStream) {
