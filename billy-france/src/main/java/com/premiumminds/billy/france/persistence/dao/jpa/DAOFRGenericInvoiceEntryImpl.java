...
public class DAOFRGenericInvoiceEntryImpl
        extends AbstractDAOFRGenericInvoiceEntryImpl<FRGenericInvoiceEntryEntity, JPAFRGenericInvoiceEntryEntity>
        implements DAOFRGenericInvoiceEntry {

    @Inject
    public DAOFRGenericInvoiceEntryImpl(Provider<EntityManager> emProvider) {
        super(emProvider);
    }

    @Override
    public FRGenericInvoiceEntryEntity getEntityInstance() {
