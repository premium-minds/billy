...
public class DAOFRGenericInvoiceImpl
        extends AbstractDAOFRGenericInvoiceImpl<FRGenericInvoiceEntity, JPAFRGenericInvoiceEntity>
        implements DAOFRGenericInvoice {

    @Inject
    public DAOFRGenericInvoiceImpl(Provider<EntityManager> emProvider) {
        super(emProvider);
    }

    @Override
    public FRGenericInvoiceEntity getEntityInstance() {
