...
public class JPAFRRegionContextEntity extends JPAContextEntity implements FRRegionContextEntity {

    private static final long serialVersionUID = 1L;

    public JPAFRRegionContextEntity() {
    }

    @Override
    public FRRegionContext getParentContext() {
        return (FRRegionContext) super.getParentContext();
    }
