...
public class DAOFRReceiptImpl extends AbstractDAOFRGenericInvoiceImpl<FRReceiptEntity, JPAFRReceiptEntity>
        implements DAOFRReceipt {

    @Inject
    public DAOFRReceiptImpl(Provider<EntityManager> emProvider) {
        super(emProvider);
    }

    @Override
    public FRReceiptEntity getEntityInstance() {
