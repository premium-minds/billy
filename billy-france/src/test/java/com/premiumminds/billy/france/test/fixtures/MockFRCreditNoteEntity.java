...
public class MockFRCreditNoteEntity extends MockGenericInvoiceEntity implements FRCreditNoteEntity {
    ...
    public List<FRCreditNoteEntry> getEntries() {
        return (List<FRCreditNoteEntry>) (List<?>) super.getEntries();
    }
