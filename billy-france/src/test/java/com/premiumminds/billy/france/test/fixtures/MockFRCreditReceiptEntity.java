...
public class MockFRCreditReceiptEntity extends MockGenericInvoiceEntity implements FRCreditReceiptEntity {
    ...
    public MockFRCreditReceiptEntity() {
    ...
    @Override
    public List<FRCreditReceiptEntry> getEntries() {
        return (List<FRCreditReceiptEntry>) (List<?>) super.getEntries();
    }
