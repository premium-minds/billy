...
public class TestESCreditNoteBuilder extends ESAbstractTest {
  ...
  @Test
  public void doTest() {
    MockESCreditNoteEntity mock = this.createMockEntity(MockESCreditNoteEntity.class,
    ...
    Mockito.when(this.getInstance(DAOESCreditNoteEntry.class).get(Matchers.any(UID.class)))
