...
public class TestJPAESBusiness extends ESJPAAbstractTest {
	...
	class TestRunner implements Callable<Void> {
		...
		public Void call() throws Exception {
			ESJPAAbstractTest.execute(this.injector,
					TestJPAESBusiness.this.transaction);
			return null;
		}
	}
	...
	public void setUp() {
		this.transaction = new TransactionWrapper<Void>(
			...
			public Void runTransaction() throws Exception {
				new ESBusinessTestUtil(ESAbstractTest.injector)
	...
	public void testConcurrentCreate() throws Exception {
		...
		DAOESBusiness biz = ESAbstractTest.injector
				.getInstance(DAOESBusiness.class);
