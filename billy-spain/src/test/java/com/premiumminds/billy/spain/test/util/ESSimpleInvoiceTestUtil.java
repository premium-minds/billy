...
public class ESSimpleInvoiceTestUtil {
  ...
  public ESSimpleInvoiceEntity getSimpleInvoiceEntity(CLIENTTYPE clientType) {
    ESSimpleInvoiceEntity invoice = (ESSimpleInvoiceEntity) this
        .getSimpleInvoiceBuilder(business.getBusinessEntity(), clientType).build();

    return invoice;
  }

  public ESSimpleInvoice.Builder getSimpleInvoiceBuilder(ESBusinessEntity businessEntity,
    ...
    return invoiceBuilder.setBilled(ESInvoiceTestUtil.BILLED)
        ...
        .setBusinessUID(businessEntity.getUID()).addPayment(payment.getPaymentBuilder())
