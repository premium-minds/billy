...
public class TestESContactBuilder extends ESAbstractTest {
	...
	private static final String	ESCONTACT_YML	= AbstractTest.YML_CONFIGS_DIR
														+ "ESContact.yml";

	@Test
	public void doTest() {
		MockESContactEntity mockContact = this.createMockEntity(
				MockESContactEntity.class, TestESContactBuilder.ESCONTACT_YML);
