...
public class TestESCreditReceiptEntryBuilder extends ESAbstractTest {
  ...
  public void doTest() {
    ...
    MockESReceiptEntity mockReceiptEntity = this.createMockEntity(MockESReceiptEntity.class,
        TestESCreditReceiptEntryBuilder.ES_RECEIPT_YML);

    Mockito.when(this.getInstance(DAOESReceipt.class).get(Matchers.any(UID.class)))
        .thenReturn(mockReceiptEntity);
