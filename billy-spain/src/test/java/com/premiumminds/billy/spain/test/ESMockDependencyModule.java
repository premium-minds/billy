...
public class ESMockDependencyModule extends MockDependencyModule {
  ...
  protected void configure() {
    ...
    this.bind(DAOESGenericInvoiceEntry.class)
        .toInstance(Mockito.mock(DAOESGenericInvoiceEntryImpl.class));
    ...
    this.bind(DAOESCreditReceiptEntry.class)
        .toInstance(Mockito.mock(DAOESCreditReceiptEntryImpl.class));
  }
