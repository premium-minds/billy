...
public class ESApplicationTestUtil {
  ...
  public ESApplication.Builder getApplicationBuilder(String appName, String version,
      String companyName, String companyTaxId, String website, ESContact.Builder contactBuilder)
  ...
  public ESApplication.Builder getApplicationBuilder() throws MalformedURLException {
    ...
    return this.getApplicationBuilder(ESApplicationTestUtil.APP_NAME, ESApplicationTestUtil.VERSION,
        ...
        ESApplicationTestUtil.WEBSITE, contactBuilder);
  }
}
