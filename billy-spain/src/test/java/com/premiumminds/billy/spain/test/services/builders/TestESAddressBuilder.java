...
public class TestESAddressBuilder extends ESAbstractTest {
	...
	private static final String	ESADDRESS_YML	= AbstractTest.YML_CONFIGS_DIR
														+ "ESAddress.yml";

	@Test
	public void doTest() {

		MockESAddressEntity mockAddress = this.createMockEntity(
				MockESAddressEntity.class, TestESAddressBuilder.ESADDRESS_YML);
