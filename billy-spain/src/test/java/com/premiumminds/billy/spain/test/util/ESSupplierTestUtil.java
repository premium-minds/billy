...
public class ESSupplierTestUtil {
	...
	public ESSupplierEntity getSupplierEntity() {
		...
		return this.getSupplierEntity(ESSupplierTestUtil.NAME,
				ESSupplierTestUtil.NUMBER, ESSupplierTestUtil.SELF_BILLING,
				addressBuilder, contactBuilder);
	}

	public ESSupplierEntity getSupplierEntity(String name, String taxNumber,
			boolean selfBillingAgree, ESAddress.Builder addressBuilder,
			ESContact.Builder contactBuilder) {

		return (ESSupplierEntity) this.getSupplierBuilder(name, taxNumber,
				selfBillingAgree, addressBuilder, contactBuilder).build();
	}

	public ESSupplier.Builder getSupplierBuilder(String name, String taxNumber,
			boolean selfBillingAgree, ESAddress.Builder addressBuilder,
			ESContact.Builder contactBuilder) {
		ESSupplier.Builder supplierBuilder = this.injector
				.getInstance(ESSupplier.Builder.class);
