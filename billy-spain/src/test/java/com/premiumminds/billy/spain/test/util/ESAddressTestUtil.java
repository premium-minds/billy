...
public class ESAddressTestUtil {
  ...
  public ESAddress.Builder getAddressBuilder(String streetName, String number, String details,
  ...
  public ESAddress.Builder getAddressBuilder() {
    return this.getAddressBuilder(ESAddressTestUtil.STREET, ESAddressTestUtil.NUMBER,
        ESAddressTestUtil.DETAILS, ESAddressTestUtil.BUILDING, ESAddressTestUtil.CITY,
        ESAddressTestUtil.POSTAL_CODE, ESAddressTestUtil.REGION, ESAddressTestUtil.ISOCODE);
  }
}
