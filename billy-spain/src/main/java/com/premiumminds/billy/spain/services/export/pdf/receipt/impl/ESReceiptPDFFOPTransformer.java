 ...
 */
package com.premiumminds.billy.spain.services.export.pdf.receipt.impl;
...
implements ESReceiptPDFTransformer {
	...
	protected ParamsTree<String, String> mapDocumentToParamsTree(ESReceiptData entity) {
		...
		super.setBusiness(params, entity);
		super.setEntries(taxTotals, params, entity);
		super.setTaxDetails(taxTotals, params);
		super.setTaxValues(params, entity);
