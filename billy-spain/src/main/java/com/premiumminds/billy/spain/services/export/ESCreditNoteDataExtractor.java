...
public class ESCreditNoteDataExtractor extends AbstractBillyDataExtractor
    ...
    @Override
    public ESCreditNoteData extract(StringID<GenericInvoice> uid) throws ExportServiceException {
        ...
        return new ESCreditNoteData(entity.getNumber(), entity.getLocalDate(), entity.getSettlementDate(),
