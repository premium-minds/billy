...
public class ESReceiptInvoiceIssuingHandler extends ESGenericInvoiceIssuingHandler implements DocumentIssuingHandler {

    private final DAOESReceiptInvoice daoReceiptInvoice;

    @Inject
    public ESReceiptInvoiceIssuingHandler(DAOInvoiceSeries daoInvoiceSeries, DAOESReceiptInvoice daoRecepit) {
    ...
    public <T extends GenericInvoice, P extends IssuingParams> T issue(T document, P parameters)
        ...
        return this.issue(document, parametersES, this.daoReceiptInvoice);
    }
