...
public class ESCreditReceiptDataExtractor extends AbstractBillyDataExtractor
    ...
    @Override
    public ESCreditReceiptData extract(StringID<GenericInvoice> uid) throws ExportServiceException {
        ...
        return new ESCreditReceiptData(entity.getNumber(), entity.getLocalDate(), entity.getSettlementDate(),
                                       payments, business, entries, entity.getTaxAmount(),
    ...
    private List<ESCreditReceiptEntryData> extractCreditEntries(List<ESCreditReceiptEntry> entryEntities)
        ...
        for (ESCreditReceiptEntry entry : entryEntities) {
            ...
            entries.add(new ESCreditReceiptEntryData(
