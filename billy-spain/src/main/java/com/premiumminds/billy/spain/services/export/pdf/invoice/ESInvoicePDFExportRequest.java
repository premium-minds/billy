...
public class ESInvoicePDFExportRequest extends AbstractExportRequest {
    ...
    public ESInvoicePDFExportRequest(StringID<GenericInvoice> uid, ESInvoiceTemplateBundle bundle) {
        super(uid, bundle);
    }

    public ESInvoicePDFExportRequest(StringID<GenericInvoice> uid, ESInvoiceTemplateBundle bundle, String resultPath) {
