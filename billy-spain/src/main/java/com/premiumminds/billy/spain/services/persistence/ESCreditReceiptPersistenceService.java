...
public class ESCreditReceiptPersistenceService implements
	PersistenceService<ESCreditReceipt> {
		...
		try {
			return new TransactionWrapper<ESCreditReceipt>(daoCreditReceipt) {
				...
				public ESCreditReceipt runTransaction() throws Exception {
					ESCreditReceiptEntity entity = (ESCreditReceiptEntity) builder
							.build();
		...
		try {
			return new TransactionWrapper<List<ESCreditReceipt>>(daoCreditReceipt) {
				...
				public List<ESCreditReceipt> runTransaction() throws Exception {
					return (List<ESCreditReceipt>) daoCreditReceipt.findByReferencedDocument(uidCompany, uidInvoice);
				}
