...
public interface ESSimpleInvoice extends ESInvoice {
	...
	public static class Builder extends
		ESSimpleInvoiceBuilderImpl<Builder, ESInvoiceEntry, ESSimpleInvoice> {

		@Inject
		public Builder(DAOESSimpleInvoice daoESSimpleInvoice,
						DAOESBusiness daoESBusiness,
						DAOESCustomer daoESCustomer, DAOESSupplier daoESSupplier) {
			super(daoESSimpleInvoice, daoESBusiness, daoESCustomer,
					daoESSupplier);
		}
	}
