...
public class ESCreditReceiptData extends GenericInvoiceData {
  ...
  public ESCreditReceiptData(String number, Date date, Date settlementDate,
      List<PaymentData> payments, BusinessData business, List<ESCreditReceiptEntryData> entries,
      BigDecimal taxAmount, BigDecimal amountWithTax, BigDecimal amountWithoutTax,
      String settlementDescription) {

    super(number, date, settlementDate, payments, null, business,
        new ArrayList<InvoiceEntryData>(0), taxAmount, amountWithTax, amountWithoutTax,
