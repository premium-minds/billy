...
public abstract class ESAbstractFOPPDFTransformer<T extends GenericInvoiceData>
  ...
  public ESAbstractFOPPDFTransformer(Class<T> transformableClass, MathContext mc,
