...
public interface ESCreditNote extends ESGenericInvoice {
  ...
  public static class Builder
      extends ESCreditNoteBuilderImpl<Builder, ESCreditNoteEntry, ESCreditNote> {

    @Inject
    public Builder(DAOESCreditNote daoESCreditNote, DAOESBusiness daoESBusiness,
  ...
  public static class ManualBuilder
    ...
    @Inject
    public ManualBuilder(DAOESCreditNote daoESCreditNote, DAOESBusiness daoESBusiness,
        DAOESCustomer daoESCustomer, DAOESSupplier daoESSupplier) {
      super(daoESCreditNote, daoESBusiness, daoESCustomer, daoESSupplier);
    }
  }
