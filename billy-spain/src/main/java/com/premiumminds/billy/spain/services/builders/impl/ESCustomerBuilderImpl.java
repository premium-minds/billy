...
public class ESCustomerBuilderImpl<TBuilder extends ESCustomerBuilderImpl<TBuilder, TCustomer>, TCustomer extends ESCustomer>
	...
	ESCustomerBuilder<TBuilder, TCustomer> {

	protected static final Localizer	LOCALIZER	= new Localizer(
			"com/premiumminds/billy/core/i18n/FieldNames");

	@Inject
	protected ESCustomerBuilderImpl(DAOESCustomer daoESCustomer,
	...
	public <T extends Address> TBuilder setBillingAddress(
		...
		BillyValidator.notNull(addressBuilder,
				ESCustomerBuilderImpl.LOCALIZER
	...
	public TBuilder setHasSelfBillingAgreement(boolean selfBiling) {
		BillyValidator.notNull(selfBiling, ESCustomerBuilderImpl.LOCALIZER
	...
	protected void validateInstance() throws BillyValidationException {
		...
		BillyValidator.mandatory(c.getName(), ESCustomerBuilderImpl.LOCALIZER
