...
public interface ESCreditReceiptEntry extends ESGenericInvoiceEntry {
  ...
  public static class Builder
      extends ESCreditReceiptEntryBuilderImpl<Builder, ESCreditReceiptEntry> {

    @Inject
    public Builder(DAOESCreditReceiptEntry daoESCreditReceiptEntry, DAOESReceipt daoESReceipt,
