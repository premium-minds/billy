...
public class ESCreditReceiptExtractor extends AbstractBillyDataExtractor implements BillyDataExtractor<ESCreditReceiptData> {
	
	private final DAOESCreditReceipt daoESReceipt;
	private final ESReceiptExtractor receiptExtractor;
	
	@Inject
	public ESCreditReceiptExtractor(DAOESCreditReceipt daoESReceipt, ESReceiptExtractor receiptExtractor) {
