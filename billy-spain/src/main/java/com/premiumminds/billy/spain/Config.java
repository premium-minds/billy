                ...
                public static class Continental {
                    ...
                    public static class VAT {
                        ...
                        public static final String INTERMEDIATE_UUID =
                                "context.spain.continental.tax.vat.intermediate.uuid";
                        public static final String INTERMEDIATE_PERCENT =
                                "context.spain.continental.tax.vat.intermediate.percent";
                        ...
                        public static final String REDUCED_PERCENT =
                                "context.spain.continental.tax.vat.reduced.percent";
                    }
                ...
                public static class CanaryIslands {
                    ...
                    public static class IGIC {
                        ...
                        public static final String NORMAL_PERCENT =
                                "context.spain.canaryislands.tax.igic.normal.percent";

                        public static final String INTERMEDIATE_UUID =
                                "context.spain.canaryislands.tax.igic.intermediate.uuid";
                        public static final String INTERMEDIATE_PERCENT =
                                "context.spain.canaryislands.tax.igic.intermediate.percent";

                        public static final String REDUCED_UUID = "context.spain.canaryislands.tax.igic.reduced.uuid";
                        public static final String REDUCED_PERCENT =
                                "context.spain.canaryislands.tax.igic.reduced.percent";
                    }
