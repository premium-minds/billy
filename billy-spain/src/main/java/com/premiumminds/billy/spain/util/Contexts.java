  ...
  public class Spain {
    ...
    public ESRegionContext allRegions() {
      ...
      return (ESRegionContext) dao
          .get(Contexts.this.configuration.getUID(Config.Key.Context.Spain.UUID));
    }
  }
  ...
  public class Continent {
    ...
    public ESRegionContext albacete() {
      ...
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Albacete.UUID));
    }

    public ESRegionContext alicante() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Alicante.UUID));
    }

    public ESRegionContext almeria() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Almeria.UUID));
    }

    public ESRegionContext asturias() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Asturias.UUID));
    }
    ...
    public ESRegionContext badajoz() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Badajoz.UUID));
    }

    public ESRegionContext baleares() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Baleares.UUID));
    }

    public ESRegionContext barcelona() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Barcelona.UUID));
    }

    public ESRegionContext bizkaia() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Bizkaia.UUID));
    }

    public ESRegionContext burgos() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Burgos.UUID));
    }

    public ESRegionContext caceres() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Caceres.UUID));
    }
    ...
    public ESRegionContext cantabria() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Cantabria.UUID));
    }

    public ESRegionContext castellon() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Castellon.UUID));
    }

    public ESRegionContext ciudadReal() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.CiudadReal.UUID));
    }

    public ESRegionContext cordoba() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Cordoba.UUID));
    }

    public ESRegionContext cuenca() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Cuenca.UUID));
    }

    public ESRegionContext gerona() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Gerona.UUID));
    }

    public ESRegionContext gipuzkoa() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Gipuzkoa.UUID));
    }

    public ESRegionContext granada() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Granada.UUID));
    }
    ...
    public ESRegionContext huelva() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Huelva.UUID));
    }

    public ESRegionContext huesca() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Huesca.UUID));
    }
    ...
    public ESRegionContext laCoruna() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.LaCoruna.UUID));
    }

    public ESRegionContext laRioja() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.LaRioja.UUID));
    }
    ...
    public ESRegionContext lerida() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Lerida.UUID));
    }
    ...
    public ESRegionContext madrid() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Madrid.UUID));
    }

    public ESRegionContext malaga() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Malaga.UUID));
    }

    public ESRegionContext murcia() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Murcia.UUID));
    }

    public ESRegionContext navarra() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Navarra.UUID));
    }

    public ESRegionContext orense() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Orense.UUID));
    }

    public ESRegionContext palencia() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Palencia.UUID));
    }

    public ESRegionContext pontevedra() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Pontevedra.UUID));
    }

    public ESRegionContext salamanca() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Salamanca.UUID));
    }

    public ESRegionContext segovia() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Segovia.UUID));
    }

    public ESRegionContext sevilla() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Sevilla.UUID));
    }
    ...
    public ESRegionContext tarragona() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Tarragona.UUID));
    }

    public ESRegionContext teruel() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Teruel.UUID));
    }

    public ESRegionContext toledo() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Toledo.UUID));
    }

    public ESRegionContext valencia() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Valencia.UUID));
    }

    public ESRegionContext valladolid() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Valladolid.UUID));
    }

    public ESRegionContext zamora() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Zamora.UUID));
    }

    public ESRegionContext zaragoza() {
      DAOESRegionContext dao = Contexts.this.getInstance(DAOESRegionContext.class);
      return (ESRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Spain.Continental.Zaragoza.UUID));
    }
