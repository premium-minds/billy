...
public class ESPaymentBuilderImpl<TBuilder extends ESPaymentBuilderImpl<TBuilder, TPayment>, TPayment extends ESPayment>
		...
		ESPaymentBuilder<TBuilder, TPayment> {

	protected static final Localizer LOCALIZER = new Localizer(
			"com/premiumminds/billy/spain/i18n/FieldNames");
	...
	public TBuilder setPaymentAmount(BigDecimal amount) {
		BillyValidator.notNull(amount, ESPaymentBuilderImpl.LOCALIZER
	...
	public TBuilder setPaymentMethod(Enum<?> method) {
		BillyValidator.notNull(method, ESPaymentBuilderImpl.LOCALIZER
	...
	public TBuilder setPaymentDate(Date date) {
		BillyValidator.notNull(date, ESPaymentBuilderImpl.LOCALIZER
	...
	protected void validateInstance() throws BillyValidationException,
		...
		BillyValidator.mandatory(p.getPaymentAmount(), ESPaymentBuilderImpl.LOCALIZER
				.getString("field.payment_amount"));
		BillyValidator.mandatory(p.getPaymentMethod(), ESPaymentBuilderImpl.LOCALIZER
				.getString("field.payment_method"));
		BillyValidator.mandatory(p.getPaymentDate(), ESPaymentBuilderImpl.LOCALIZER
				.getString("field.payment_date"));
	}
