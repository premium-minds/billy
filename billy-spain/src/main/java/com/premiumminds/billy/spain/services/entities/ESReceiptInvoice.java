...
import com.premiumminds.billy.spain.services.builders.impl.ESReceiptInvoiceBuilderImpl;

public interface ESReceiptInvoice extends ESInvoice {

	public static class Builder
			extends
			ESReceiptInvoiceBuilderImpl<Builder, ESInvoiceEntry, ESReceiptInvoice> {

		@Inject
		public Builder(DAOESReceiptInvoice daoESReceiptInvoice, DAOESBusiness daoESBusiness,
