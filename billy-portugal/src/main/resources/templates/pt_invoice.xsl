			...
			<fo:page-sequence master-reference="A4">
				...
				<fo:flow flow-name="xsl-region-body">
								...
								<fo:table-row>
									<fo:table-cell display-align="after">
										<fo:block font-size="8pt" margin-bottom="3mm">
											<!-- <xsl:choose> <xsl:when test="./customer/id"> Cliente nº: 
												<xsl:value-of select="./customer/id" /> </xsl:when> </xsl:choose> <fo:block 
												/> -->
											Contribuinte nº:
					...
					<fo:block font-size="8pt" margin-top="3mm" margin-bottom="4mm">
						<fo:block font-weight="bold" font-size="6pt">Detalhes de
							Faturação
						</fo:block>
						<fo:table width="100%">
