...
public class GeneralLedgerEntries implements ToString {
	...
	public List<GeneralLedgerEntries.Journal> getJournal() {
		if (this.journal == null) {
			this.journal = new ArrayList<GeneralLedgerEntries.Journal>();
		}
		return this.journal;
	}
	...
	public StringBuilder appendFields(ObjectLocator locator,
		...
		}
		{
			...
			theJournal = (((this.journal != null) && (!this.journal.isEmpty())) ? this
					.getJournal() : null);
	...
	public static class Journal implements ToString {
		...
		public List<GeneralLedgerEntries.Journal.Transaction> getTransaction() {
			if (this.transaction == null) {
				this.transaction = new ArrayList<GeneralLedgerEntries.Journal.Transaction>();
			}
		...
		public StringBuilder appendFields(ObjectLocator locator,
				StringBuilder buffer, ToStringStrategy strategy) {
			{
				...
				strategy.appendField(locator, this, "journalID", buffer,
						theJournalID);
			}
			{
			...
			}
			{
				...
				theTransaction = (((this.transaction != null) && (!this.transaction
						.isEmpty())) ? this.getTransaction() : null);
				strategy.appendField(locator, this, "transaction", buffer,
						theTransaction);
			}
			return buffer;
		}
		 ...
		 */
		@XmlAccessorType(XmlAccessType.FIELD)
		@XmlType(name = "", propOrder = { "transactionID", "period",
				"transactionDate", "sourceID", "description",
				"docArchivalNumber", "transactionType", "glPostingDate",
				"customerID", "supplierID", "line" })
		public static class Transaction implements ToString {
			...
			public List<GeneralLedgerEntries.Journal.Transaction.Line> getLine() {
				if (this.line == null) {
					this.line = new ArrayList<GeneralLedgerEntries.Journal.Transaction.Line>();
				}
				return this.line;
			}
			...
			public StringBuilder appendFields(ObjectLocator locator,
				...
				}
				{
					...
					strategy.appendField(locator, this, "transactionDate",
							buffer, theTransactionDate);
				}
				{
					String theSourceID;
				...
				}
				{
					...
					strategy.appendField(locator, this, "docArchivalNumber",
							buffer, theDocArchivalNumber);
				}
				{
					String theTransactionType;
					theTransactionType = this.getTransactionType();
					strategy.appendField(locator, this, "transactionType",
							buffer, theTransactionType);
				}
				{
					XMLGregorianCalendar theGLPostingDate;
					theGLPostingDate = this.getGLPostingDate();
					strategy.appendField(locator, this, "glPostingDate",
							buffer, theGLPostingDate);
				}
				{
			 ...
			 */
			@XmlAccessorType(XmlAccessType.FIELD)
			@XmlType(name = "", propOrder = { "recordID", "accountID",
					"sourceDocumentID", "systemEntryDate", "description",
			...
			public static class Line implements ToString {
				...
				public StringBuilder appendFields(ObjectLocator locator,
						StringBuilder buffer, ToStringStrategy strategy) {
					{
						...
						strategy.appendField(locator, this, "recordID", buffer,
								theRecordID);
					}
					{
						String theAccountID;
						theAccountID = this.getAccountID();
						strategy.appendField(locator, this, "accountID",
								buffer, theAccountID);
					}
					{
						String theSourceDocumentID;
						theSourceDocumentID = this.getSourceDocumentID();
						strategy.appendField(locator, this, "sourceDocumentID",
								buffer, theSourceDocumentID);
					}
					{
