...
@XmlType(name = "", propOrder = { "header", "masterFiles",
		"generalLedgerEntries", "sourceDocuments" })
@XmlRootElement(name = "AuditFile")
public class AuditFile implements ToString {
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link AuditFile.MasterFiles }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link GeneralLedgerEntries }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link SourceDocuments }
	 * 
	 */
	...
	public StringBuilder appendFields(ObjectLocator locator,
		...
		}
		{
			...
			strategy.appendField(locator, this, "masterFiles", buffer,
					theMasterFiles);
		}
		{
			GeneralLedgerEntries theGeneralLedgerEntries;
			theGeneralLedgerEntries = this.getGeneralLedgerEntries();
			strategy.appendField(locator, this, "generalLedgerEntries", buffer,
					theGeneralLedgerEntries);
		}
		{
			SourceDocuments theSourceDocuments;
			theSourceDocuments = this.getSourceDocuments();
			strategy.appendField(locator, this, "sourceDocuments", buffer,
					theSourceDocuments);
		}
		return buffer;
	}
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "generalLedger", "customer", "supplier",
			"product", "taxTable" })
	public static class MasterFiles implements ToString {
		 ...
		 * <CODE>set</CODE> method for the generalLedger property.
		 * 
		 * <p>
		...
		public List<GeneralLedger> getGeneralLedger() {
			if (this.generalLedger == null) {
				this.generalLedger = new ArrayList<GeneralLedger>();
			}
		 ...
		 * 
		 * @param value
		 *            allowed object is {@link TaxTable }
		 * 
		 */
		...
		public StringBuilder appendFields(ObjectLocator locator,
				StringBuilder buffer, ToStringStrategy strategy) {
			{
				...
				theGeneralLedger = (((this.generalLedger != null) && (!this.generalLedger
						.isEmpty())) ? this.getGeneralLedger() : null);
				strategy.appendField(locator, this, "generalLedger", buffer,
						theGeneralLedger);
			}
			{
				List<Customer> theCustomer;
				theCustomer = (((this.customer != null) && (!this.customer
						.isEmpty())) ? this.getCustomer() : null);
				strategy.appendField(locator, this, "customer", buffer,
						theCustomer);
			}
			{
				List<Supplier> theSupplier;
				theSupplier = (((this.supplier != null) && (!this.supplier
						.isEmpty())) ? this.getSupplier() : null);
				strategy.appendField(locator, this, "supplier", buffer,
						theSupplier);
			}
			{
				List<Product> theProduct;
				theProduct = (((this.product != null) && (!this.product
						.isEmpty())) ? this.getProduct() : null);
				strategy.appendField(locator, this, "product", buffer,
						theProduct);
			}
			{
				TaxTable theTaxTable;
				theTaxTable = this.getTaxTable();
				strategy.appendField(locator, this, "taxTable", buffer,
						theTaxTable);
			}
			return buffer;
		}
