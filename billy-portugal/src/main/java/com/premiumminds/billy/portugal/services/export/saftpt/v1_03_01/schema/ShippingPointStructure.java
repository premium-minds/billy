    ...
    implements ToString
{
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "LocationID", namespace = "urn:OECD:StandardAuditFile-Tax:PT_1.03_01", type = JAXBElement.class),
        @XmlElementRef(name = "WarehouseID", namespace = "urn:OECD:StandardAuditFile-Tax:PT_1.03_01", type = JAXBElement.class)
    })
