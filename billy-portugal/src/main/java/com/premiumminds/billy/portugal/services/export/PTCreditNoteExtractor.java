...
public class PTCreditNoteExtractor extends AbstractBillyDataExtractor implements BillyDataExtractor<PTCreditNoteData> {
	
	private final DAOPTCreditNote daoPTCreditNote;
	
	@Inject
	public PTCreditNoteExtractor(DAOPTCreditNote daoPTCreditNote) {
