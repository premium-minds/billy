...
public class PTSAFTFileGenerator {
  ...
  public void generateSAFTFile(final OutputStream targetStream,
    ...
    switch (version) {
    case V10201:
      saftGenV1_02_01.generateSAFTFile(targetStream, businessEntity, application, certificateNumber,
          fromDate, toDate);
      return;
    case V10301:
    case CURRENT:
    default:
      saftGenV1_03_01.generateSAFTFile(targetStream, businessEntity, application, certificateNumber,
          fromDate, toDate);
      return;
    }
