...
@XmlType(name = "", propOrder = { "auditFileVersion", "companyID",
		"taxRegistrationNumber", "taxAccountingBasis", "companyName",
		"businessName", "companyAddress", "fiscalYear", "startDate", "endDate",
		"currencyCode", "dateCreated", "taxEntity", "productCompanyTaxID",
		"softwareCertificateNumber", "productID", "productVersion",
		"headerComment", "telephone", "fax", "email", "website" })
@XmlRootElement(name = "Header")
public class Header implements ToString {
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link AddressStructurePT }
	 * 
	 */
	...
	public StringBuilder appendFields(ObjectLocator locator,
			StringBuilder buffer, ToStringStrategy strategy) {
		{
			...
			strategy.appendField(locator, this, "auditFileVersion", buffer,
					theAuditFileVersion);
		}
		{
			String theCompanyID;
			theCompanyID = this.getCompanyID();
			strategy.appendField(locator, this, "companyID", buffer,
					theCompanyID);
		}
		{
			int theTaxRegistrationNumber;
			theTaxRegistrationNumber = (true ? this.getTaxRegistrationNumber()
					: 0);
			strategy.appendField(locator, this, "taxRegistrationNumber",
					buffer, theTaxRegistrationNumber);
		}
		{
			String theTaxAccountingBasis;
			theTaxAccountingBasis = this.getTaxAccountingBasis();
			strategy.appendField(locator, this, "taxAccountingBasis", buffer,
					theTaxAccountingBasis);
		}
		{
		...
		}
		{
			...
			strategy.appendField(locator, this, "businessName", buffer,
					theBusinessName);
		}
		{
			AddressStructurePT theCompanyAddress;
			theCompanyAddress = this.getCompanyAddress();
			strategy.appendField(locator, this, "companyAddress", buffer,
					theCompanyAddress);
		}
		{
			int theFiscalYear;
			theFiscalYear = (true ? this.getFiscalYear() : 0);
			strategy.appendField(locator, this, "fiscalYear", buffer,
					theFiscalYear);
		}
		{
			XMLGregorianCalendar theStartDate;
			theStartDate = this.getStartDate();
			strategy.appendField(locator, this, "startDate", buffer,
					theStartDate);
		}
		{
		...
		}
		{
			...
			strategy.appendField(locator, this, "dateCreated", buffer,
					theDateCreated);
		}
		{
			String theTaxEntity;
			theTaxEntity = this.getTaxEntity();
			strategy.appendField(locator, this, "taxEntity", buffer,
					theTaxEntity);
		}
		{
			String theProductCompanyTaxID;
			theProductCompanyTaxID = this.getProductCompanyTaxID();
			strategy.appendField(locator, this, "productCompanyTaxID", buffer,
					theProductCompanyTaxID);
		}
		{
			BigInteger theSoftwareCertificateNumber;
			theSoftwareCertificateNumber = this.getSoftwareCertificateNumber();
			strategy.appendField(locator, this, "softwareCertificateNumber",
					buffer, theSoftwareCertificateNumber);
		}
		{
			String theProductID;
			theProductID = this.getProductID();
			strategy.appendField(locator, this, "productID", buffer,
					theProductID);
		}
		{
			String theProductVersion;
			theProductVersion = this.getProductVersion();
			strategy.appendField(locator, this, "productVersion", buffer,
					theProductVersion);
		}
		{
			String theHeaderComment;
			theHeaderComment = this.getHeaderComment();
			strategy.appendField(locator, this, "headerComment", buffer,
					theHeaderComment);
		}
		{
			String theTelephone;
