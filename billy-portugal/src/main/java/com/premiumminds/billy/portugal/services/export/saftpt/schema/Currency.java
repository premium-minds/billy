...
@XmlType(name = "Currency", propOrder = { "currencyCode", "currencyAmount",
		"exchangeRate" })
public class Currency implements ToString {
	...
	public StringBuilder appendFields(ObjectLocator locator,
		...
		}
		{
			...
			strategy.appendField(locator, this, "currencyAmount", buffer,
					theCurrencyAmount);
		}
		{
			BigDecimal theExchangeRate;
			theExchangeRate = this.getExchangeRate();
			strategy.appendField(locator, this, "exchangeRate", buffer,
					theExchangeRate);
		}
		return buffer;
	}
