...
public abstract class PTManualEntryBuilderImpl<
    TBuilder extends PTManualEntryBuilderImpl<TBuilder, TEntry, TDAOEntry, TDAOInvoice>,
    TEntry extends PTGenericInvoiceEntry, TDAOEntry extends AbstractDAOGenericInvoiceEntry<?>,
  ...
  public PTManualEntryBuilderImpl(
      TDAOEntry daoPTEntry,
      TDAOInvoice daoPTInvoice,
      DAOPTTax daoPTTax,
  ...
  public TBuilder setUnitAmount(AmountType type, BigDecimal amount) {
    BillyValidator.notNull(type,
        PTGenericInvoiceEntryBuilderImpl.LOCALIZER.getString("field.unit_amount_type"));
    BillyValidator.notNull(amount,
        PTGenericInvoiceEntryBuilderImpl.LOCALIZER.getString("field.unit_gross_amount"));
  ...
  public TBuilder setAmount(AmountType type, BigDecimal amount) {
    BillyValidator.notNull(type,
        PTGenericInvoiceEntryBuilderImpl.LOCALIZER.getString("field.amount_type"));
    BillyValidator.notNull(amount,
        PTGenericInvoiceEntryBuilderImpl.LOCALIZER.getString("field.gross_amount"));
