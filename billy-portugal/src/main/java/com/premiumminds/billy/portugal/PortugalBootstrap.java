		...
		try {
			new TransactionWrapper<Void>(dao) {
				...
				public Void runTransaction() throws Exception {
					...
					// Generic Address
					final PTAddressEntity GENERIC_ADDRESS = this.buildAddressEntity(
							daoPTAddress, addressBuilder, "", "", "",
							"Desconhecido", "", "Desconhecido", "Desconhecido",
							"Desconhecido", Config.Key.Address.Generic.UUID);

					// Generic contact
					final PTContactEntity GENERIC_CONTACT = this.buildContactEntity(
							daoPTContact, contactBuilder, "John Doe",
							"111222333", "123123123", "doe@example.com",
							"321321321", "www.doe.io",
							Config.Key.Contact.Generic.UUID);

					// Generic Customer
					final PTCustomerEntity GENERIC_CUSTOMER = this.buildCustomerEntity(
							daoPTCustomer, customerBuilder, "Consumidor final",
							"999999990", addressBuilder, contactBuilder, false,
							Config.Key.Customer.Generic.UUID);

					// Portugal Contexts
					final PTRegionContextEntity CONTEXT_PORTUGAL = this.buildContextEntity(
							daoPTRegionContext, contextBuilder, "Portugal",
							"The Context for the country Portugal", null,
					...
					final PTRegionContextEntity CONTEXT_CONTINENTAL_PORTUGAL = this.buildContextEntity(
							daoPTRegionContext, contextBuilder,
					...
					final PTRegionContextEntity CONTEXT_AZORES_PORTUGAL = this.buildContextEntity(
							daoPTRegionContext, contextBuilder, "Azores",
					...
					Date to = new DateTime(2014, 1, 1, 0, 0).toDateMidnight()
															.toDateTime()
															.toDate();
					final PTTaxEntity VAT_NORMAL_CONTINENTAL_PORTUGAL = this.buildTaxEntity(
							daoPTTax,
							taxBuilder,
							PTVATCode.NORMAL,
					...
					final PTTaxEntity VAT_INTERMEDIATE_CONTINENTAL_PORTUGAL = this.buildTaxEntity(
							daoPTTax,
							taxBuilder,
					...
					final PTTaxEntity VAT_REDUCED_CONTINENTAL_PORTUGAL = this.buildTaxEntity(
							daoPTTax,
							taxBuilder,
							PTVATCode.REDUCED,
							CONTEXT_CONTINENTAL_PORTUGAL,
					...
					// Madeira
					final PTTaxEntity VAT_NORMAL_MADEIRA_PORTUGAL = this.buildTaxEntity(
							daoPTTax,
							taxBuilder,
							PTVATCode.NORMAL,
					...
					final PTTaxEntity VAT_INTERMEDIATE_MADEIRA_PORTUGAL = this.buildTaxEntity(
							daoPTTax,
							taxBuilder,
							PTVATCode.INTERMEDIATE,
							CONTEXT_MADEIRA_PORTUGAL,
					...
					final PTTaxEntity VAT_REDUCED_MADEIRA_PORTUGAL = this.buildTaxEntity(
							daoPTTax,
							taxBuilder,
							PTVATCode.REDUCED,
							CONTEXT_MADEIRA_PORTUGAL,
					...
					final PTTaxEntity VAT_NORMAL_AZORES_PORTUGAL = this.buildTaxEntity(
							daoPTTax,
							taxBuilder,
							PTVATCode.NORMAL,
					...
					// Azores
					final PTTaxEntity VAT_INTERMEDIATE_AZORES_PORTUGAL = this.buildTaxEntity(
							daoPTTax,
							taxBuilder,
							PTVATCode.INTERMEDIATE,
							CONTEXT_AZORES_PORTUGAL,
					...
					final PTTaxEntity VAT_REDUCED_AZORES_PORTUGAL = this.buildTaxEntity(
							daoPTTax,
							taxBuilder,
							PTVATCode.REDUCED,
							CONTEXT_AZORES_PORTUGAL,
					...
					final PTTaxEntity TAX_EXEMPT_PORTUGAL = this.buildTaxEntity(
							daoPTTax, taxBuilder, PTVATCode.EXEMPT,
							CONTEXT_PORTUGAL, Currency.getInstance("EUR"),
							"Isento de IVA", "IVA", Tax.TaxRateType.NONE, from,
							to, Config.Key.Context.Portugal.TAX_EXEMPT_VALUE,
				...
				private PTTaxEntity buildTaxEntity(DAOPTTax daoPTTax,
					...
					taxBuilder.setCode(taxCode).setContextUID(context.getUID())
								...
								.setTaxRate(type, amount)
								.setValidFrom(validFrom).setValidTo(validTo)
								.setValue(amount);
