    ...
    try {
      new TransactionWrapper<Void>(dao) {
        ...
        public Void runTransaction() throws Exception {
          ...
          // Generic Address
          final PTAddressEntity GENERIC_ADDRESS = this.buildAddressEntity(daoPTAddress,
              addressBuilder, null, null, null, "Desconhecido", null, "Desconhecido",
              "Desconhecido", "Desconhecido", Config.Key.Address.Generic.UUID);

          // Generic contact
          final PTContactEntity GENERIC_CONTACT = this.buildContactEntity(daoPTContact,
              contactBuilder, null, null, null, null, null, null, Config.Key.Contact.Generic.UUID);

          // Generic Customer
          final PTCustomerEntity GENERIC_CUSTOMER = this.buildCustomerEntity(daoPTCustomer,
              customerBuilder, "Consumidor final", "999999990", addressBuilder, contactBuilder,
          ...
          final PTRegionContextEntity CONTEXT_CONTINENTAL_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Portugal Continental",
          ...
          final PTRegionContextEntity CONTEXT_AVEIRO_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Aveiro",
              "The Context for the Portuguese Aveiro region", CONTEXT_CONTINENTAL_PORTUGAL.getUID(),
              PortugalBootstrap.CODE_PT_AVEIRO,
              Config.Key.Context.Portugal.Continental.Aveiro.UUID);

          final PTRegionContextEntity CONTEXT_BEJA_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Beja",
          ...
          final PTRegionContextEntity CONTEXT_BRAGA_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Braga",
              "The Context for the Portuguese Braga region", CONTEXT_CONTINENTAL_PORTUGAL.getUID(),
              PortugalBootstrap.CODE_PT_BRAGA, Config.Key.Context.Portugal.Continental.Braga.UUID);

          final PTRegionContextEntity CONTEXT_BRAGANÇA_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Bragança",
          ...
          final PTRegionContextEntity CONTEXT_CASTELO_BRANCO_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Castelo Branco",
          ...
          final PTRegionContextEntity CONTEXT_COIMBRA_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Coimbra",
          ...
          final PTRegionContextEntity CONTEXT_EVORA_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Evora",
              "The Context for the Portuguese Evora region", CONTEXT_CONTINENTAL_PORTUGAL.getUID(),
              PortugalBootstrap.CODE_PT_EVORA, Config.Key.Context.Portugal.Continental.Evora.UUID);

          final PTRegionContextEntity CONTEXT_FARO_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Faro",
          ...
          final PTRegionContextEntity CONTEXT_GUARDA_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Guarda",
              "The Context for the Portuguese Guarda region", CONTEXT_CONTINENTAL_PORTUGAL.getUID(),
              PortugalBootstrap.CODE_PT_GUARDA,
              Config.Key.Context.Portugal.Continental.Guarda.UUID);

          final PTRegionContextEntity CONTEXT_LEIRIA_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Leiria",
              "The Context for the Portuguese Leiria region", CONTEXT_CONTINENTAL_PORTUGAL.getUID(),
              PortugalBootstrap.CODE_PT_LEIRIA,
              Config.Key.Context.Portugal.Continental.Leiria.UUID);

          final PTRegionContextEntity CONTEXT_LISBOA_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Lisboa",
              "The Context for the Portuguese Lisboa region", CONTEXT_CONTINENTAL_PORTUGAL.getUID(),
              PortugalBootstrap.CODE_PT_LISBOA,
              Config.Key.Context.Portugal.Continental.Lisboa.UUID);

          final PTRegionContextEntity CONTEXT_PORTALEGRE_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Portalegre",
          ...
          final PTRegionContextEntity CONTEXT_PORTO_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Porto",
              "The Context for the Portuguese Porto region", CONTEXT_CONTINENTAL_PORTUGAL.getUID(),
              PortugalBootstrap.CODE_PT_PORTO, Config.Key.Context.Portugal.Continental.Porto.UUID);

          final PTRegionContextEntity CONTEXT_SANTAREM_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Santarem",
          ...
          final PTRegionContextEntity CONTEXT_SETUBAL_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Setubal",
          ...
          final PTRegionContextEntity CONTEXT_VIANA_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Viana do Castelo",
          ...
          final PTRegionContextEntity CONTEXT_VILA_REAL_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Vila Real",
          ...
          final PTRegionContextEntity CONTEXT_VISEU_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Viseu",
              "The Context for the Portuguese Viseu region", CONTEXT_CONTINENTAL_PORTUGAL.getUID(),
              PortugalBootstrap.CODE_PT_VISEU, Config.Key.Context.Portugal.Continental.Viseu.UUID);

          final PTRegionContextEntity CONTEXT_AZORES_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Azores", "The Context for the Portuguese Azores",
              CONTEXT_PORTUGAL.getUID(), PortugalBootstrap.CODE_PT_AZORES,
              Config.Key.Context.Portugal.Azores.UUID);

          final PTRegionContextEntity CONTEXT_MADEIRA_PORTUGAL = this.buildContextEntity(
              daoPTRegionContext, contextBuilder, "Madeira Autonomous Region",
          ...
          final PTTaxEntity VAT_NORMAL_CONTINENTAL_PORTUGAL = this.buildTaxEntity(daoPTTax,
              taxBuilder, PTVATCode.NORMAL, CONTEXT_CONTINENTAL_PORTUGAL,
              Currency.getInstance("EUR"), "IVA Normal Continente", "IVA",
              Tax.TaxRateType.PERCENTAGE, from, to,
              Config.Key.Context.Portugal.Continental.VAT.NORMAL_PERCENT,
              Config.Key.Context.Portugal.Continental.VAT.NORMAL_UUID);

          final PTTaxEntity VAT_INTERMEDIATE_CONTINENTAL_PORTUGAL = this.buildTaxEntity(daoPTTax,
              taxBuilder, PTVATCode.INTERMEDIATE, CONTEXT_CONTINENTAL_PORTUGAL,
              Currency.getInstance("EUR"), "IVA Intermedio Continente", "IVA",
              Tax.TaxRateType.PERCENTAGE, from, to,
          ...
          final PTTaxEntity VAT_REDUCED_CONTINENTAL_PORTUGAL = this.buildTaxEntity(daoPTTax,
              taxBuilder, PTVATCode.REDUCED, CONTEXT_CONTINENTAL_PORTUGAL,
              Currency.getInstance("EUR"), "IVA Reduzido Continente", "IVA",
              Tax.TaxRateType.PERCENTAGE, from, to,
          ...
          final PTTaxEntity VAT_INTERMEDIATE_MADEIRA_PORTUGAL = this.buildTaxEntity(daoPTTax,
              taxBuilder, PTVATCode.INTERMEDIATE, CONTEXT_MADEIRA_PORTUGAL,
              Currency.getInstance("EUR"), "IVA Intermedio Madeira", "IVA",
              Tax.TaxRateType.PERCENTAGE, from, to,
          ...
          final PTTaxEntity VAT_NORMAL_AZORES_PORTUGAL = this.buildTaxEntity(daoPTTax, taxBuilder,
              PTVATCode.NORMAL, CONTEXT_AZORES_PORTUGAL, Currency.getInstance("EUR"),
              "IVA Normal Açores", "IVA", Tax.TaxRateType.PERCENTAGE, from, to,
              Config.Key.Context.Portugal.Azores.VAT.NORMAL_PERCENT,
              Config.Key.Context.Portugal.Azores.VAT.NORMAL_UUID);

          // Azores
          final PTTaxEntity VAT_INTERMEDIATE_AZORES_PORTUGAL = this.buildTaxEntity(daoPTTax,
              taxBuilder, PTVATCode.INTERMEDIATE, CONTEXT_AZORES_PORTUGAL,
              Currency.getInstance("EUR"), "IVA Intermedio Açores", "IVA",
              Tax.TaxRateType.PERCENTAGE, from, to,
          ...
          final PTTaxEntity TAX_EXEMPT_PORTUGAL = this.buildTaxEntity(daoPTTax, taxBuilder,
              PTVATCode.EXEMPT, CONTEXT_PORTUGAL, Currency.getInstance("EUR"), "Isento de IVA",
              "IVA", Tax.TaxRateType.NONE, from, to, Config.Key.Context.Portugal.TAX_EXEMPT_VALUE,
              Config.Key.Context.Portugal.TAX_EXEMPT_UUID);

          return null;
        }

        private PTAddressEntity buildAddressEntity(DAOPTAddress daoPTAddress,
            Builder addressBuilder, String number, String street, String building, String city,
            String region, String isoCode, String details, String postalCode, String key) {

          addressBuilder.setCity(city).setDetails(details).setISOCountry(isoCode).setNumber(number)
              .setRegion(region).setStreetName(street).setPostalCode(postalCode)
        ...
        private PTContactEntity buildContactEntity(DAOPTContact daoPTContact,
            PTContact.Builder contactBuilder, String name, String telephone, String mobile,
            String email, String fax, String website, String key) {
        ...
        private PTTaxEntity buildTaxEntity(DAOPTTax daoPTTax, PTTax.Builder taxBuilder,
            String taxCode, PTRegionContextEntity context, Currency currency, String description,
        ...
        private PTCustomerEntity buildCustomerEntity(DAOPTCustomer daoPTCustomer,
          ...
          customerBuilder.setName(name).addContact(contactBuilder)
              ...
              .setTaxRegistrationNumber(taxRegistrationID, CODE_PT)
