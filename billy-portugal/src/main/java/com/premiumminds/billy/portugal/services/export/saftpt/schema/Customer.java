...
@XmlType(name = "", propOrder = { "customerID", "accountID", "customerTaxID",
		"companyName", "contact", "billingAddress", "shipToAddress",
...
public class Customer implements ToString {
	 ...
	 * <CODE>set</CODE> method for the shipToAddress property.
	 * 
	 * <p>
	...
	public List<AddressStructure> getShipToAddress() {
		if (this.shipToAddress == null) {
			this.shipToAddress = new ArrayList<AddressStructure>();
		}
	...
	public StringBuilder appendFields(ObjectLocator locator,
		...
		}
		{
			...
			strategy.appendField(locator, this, "customerTaxID", buffer,
					theCustomerTaxID);
		}
		{
		...
		}
		{
			...
			theShipToAddress = (((this.shipToAddress != null) && (!this.shipToAddress
					.isEmpty())) ? this.getShipToAddress() : null);
			strategy.appendField(locator, this, "shipToAddress", buffer,
					theShipToAddress);
		}
		{
			String theTelephone;
