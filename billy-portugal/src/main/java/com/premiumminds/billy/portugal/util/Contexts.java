  ...
  public class Portugal {
    ...
    public PTRegionContext allRegions() {
      ...
      return (PTRegionContext) dao
          .get(Contexts.this.configuration.getUID(Config.Key.Context.Portugal.UUID));
    }
  }
  ...
  public class Continent {
    ...
    public PTRegionContext aveiro() {
      ...
      return (PTRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Portugal.Continental.Aveiro.UUID));
    }

    public PTRegionContext beja() {
      DAOPTRegionContext dao = Contexts.this.getInstance(DAOPTRegionContext.class);
      return (PTRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Portugal.Continental.Beja.UUID));
    }

    public PTRegionContext braga() {
      DAOPTRegionContext dao = Contexts.this.getInstance(DAOPTRegionContext.class);
      return (PTRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Portugal.Continental.Braga.UUID));
    }
    ...
    public PTRegionContext coimbra() {
      DAOPTRegionContext dao = Contexts.this.getInstance(DAOPTRegionContext.class);
      return (PTRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Portugal.Continental.Coimbra.UUID));
    }

    public PTRegionContext evora() {
      DAOPTRegionContext dao = Contexts.this.getInstance(DAOPTRegionContext.class);
      return (PTRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Portugal.Continental.Evora.UUID));
    }

    public PTRegionContext faro() {
      DAOPTRegionContext dao = Contexts.this.getInstance(DAOPTRegionContext.class);
      return (PTRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Portugal.Continental.Faro.UUID));
    }

    public PTRegionContext guarda() {
      DAOPTRegionContext dao = Contexts.this.getInstance(DAOPTRegionContext.class);
      return (PTRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Portugal.Continental.Guarda.UUID));
    }

    public PTRegionContext leiria() {
      DAOPTRegionContext dao = Contexts.this.getInstance(DAOPTRegionContext.class);
      return (PTRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Portugal.Continental.Leiria.UUID));
    }

    public PTRegionContext lisboa() {
      DAOPTRegionContext dao = Contexts.this.getInstance(DAOPTRegionContext.class);
      return (PTRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Portugal.Continental.Lisboa.UUID));
    }
    ...
    public PTRegionContext porto() {
      DAOPTRegionContext dao = Contexts.this.getInstance(DAOPTRegionContext.class);
      return (PTRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Portugal.Continental.Porto.UUID));
    }
    ...
    public PTRegionContext setubal() {
      DAOPTRegionContext dao = Contexts.this.getInstance(DAOPTRegionContext.class);
      return (PTRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Portugal.Continental.Setubal.UUID));
    }

    public PTRegionContext viana() {
      DAOPTRegionContext dao = Contexts.this.getInstance(DAOPTRegionContext.class);
      return (PTRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Portugal.Continental.Viana.UUID));
    }
    ...
    public PTRegionContext viseu() {
      DAOPTRegionContext dao = Contexts.this.getInstance(DAOPTRegionContext.class);
      return (PTRegionContext) dao.get(
          Contexts.this.configuration.getUID(Config.Key.Context.Portugal.Continental.Viseu.UUID));
    }
  }
