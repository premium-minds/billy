...
@XmlType(name = "", propOrder = { "accountID", "accountDescription",
		"openingDebitBalance", "openingCreditBalance", "closingDebitBalance",
		"closingCreditBalance", "groupingCategory", "groupingCode" })
@XmlRootElement(name = "GeneralLedger")
public class GeneralLedger implements ToString {
	...
	public StringBuilder appendFields(ObjectLocator locator,
		...
		}
		{
			...
			strategy.appendField(locator, this, "accountDescription", buffer,
					theAccountDescription);
		}
		{
			BigDecimal theOpeningDebitBalance;
			theOpeningDebitBalance = this.getOpeningDebitBalance();
			strategy.appendField(locator, this, "openingDebitBalance", buffer,
					theOpeningDebitBalance);
		}
		{
			BigDecimal theOpeningCreditBalance;
			theOpeningCreditBalance = this.getOpeningCreditBalance();
			strategy.appendField(locator, this, "openingCreditBalance", buffer,
					theOpeningCreditBalance);
		}
		{
			BigDecimal theClosingDebitBalance;
			theClosingDebitBalance = this.getClosingDebitBalance();
			strategy.appendField(locator, this, "closingDebitBalance", buffer,
					theClosingDebitBalance);
		}
		{
			BigDecimal theClosingCreditBalance;
			theClosingCreditBalance = this.getClosingCreditBalance();
			strategy.appendField(locator, this, "closingCreditBalance", buffer,
					theClosingCreditBalance);
		}
		{
			String theGroupingCategory;
			theGroupingCategory = this.getGroupingCategory();
			strategy.appendField(locator, this, "groupingCategory", buffer,
					theGroupingCategory);
		}
		{
			String theGroupingCode;
			theGroupingCode = this.getGroupingCode();
			strategy.appendField(locator, this, "groupingCode", buffer,
					theGroupingCode);
		}
		return buffer;
	}
