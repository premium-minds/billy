...
@XmlType(name = "", propOrder = { "productType", "productCode", "productGroup",
		"productDescription", "productNumberCode" })
@XmlRootElement(name = "Product")
public class Product implements ToString {
	...
	public StringBuilder appendFields(ObjectLocator locator,
			StringBuilder buffer, ToStringStrategy strategy) {
		{
			...
			strategy.appendField(locator, this, "productType", buffer,
					theProductType);
		}
		{
			String theProductCode;
			theProductCode = this.getProductCode();
			strategy.appendField(locator, this, "productCode", buffer,
					theProductCode);
		}
		{
			String theProductGroup;
			theProductGroup = this.getProductGroup();
			strategy.appendField(locator, this, "productGroup", buffer,
					theProductGroup);
		}
		{
			String theProductDescription;
			theProductDescription = this.getProductDescription();
			strategy.appendField(locator, this, "productDescription", buffer,
					theProductDescription);
		}
		{
			String theProductNumberCode;
			theProductNumberCode = this.getProductNumberCode();
			strategy.appendField(locator, this, "productNumberCode", buffer,
					theProductNumberCode);
		}
		return buffer;
	}
