...
public class TestPTInvoiceEntryBuilder extends PTAbstractTest {
  ...
  @Test
  public void doTest() {
    MockPTInvoiceEntryEntity mock = this.createMockEntity(MockPTInvoiceEntryEntity.class,
    ...
    MockPTInvoiceEntity mockInvoice = this.createMockEntity(MockPTInvoiceEntity.class,
        TestPTInvoiceEntryBuilder.PT_INVOICE_YML);

    Mockito.when(this.getInstance(DAOPTInvoice.class).get(Matchers.any(UID.class)))
    ...
    Mockito.when(this.getInstance(DAOPTRegionContext.class)
