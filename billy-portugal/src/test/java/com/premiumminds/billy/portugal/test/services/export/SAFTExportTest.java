...
public class SAFTExportTest extends PTPersistencyAbstractTest {
  ...
  public void doTest() throws Exception {
    ...
    PTCustomerPersistenceService customerPersistenceService = getInstance(
        PTCustomerPersistenceService.class);
    PTSupplierPersistenceService supplierPersistenceService = getInstance(
        PTSupplierPersistenceService.class);
    ...
    /* CONTACTS */
    PTContact.Builder contactBuilder = contact.getContactBuilder("My Business", "299999999",
        "999999999", "299999998", "mybusiness@email.me", "http://www.mybusiness.web");

    PTContact.Builder contactBuilder2 = contact.getContactBuilder("Zé", "299999991", "999999991",
        "299999992", "maildoze@email.me", "http://www.zenaweb.web");

    PTContact.Builder contactBuilder3 = contact.getContactBuilder("YourSupplier", "299999993",
        "999999993", "299999994", "maildoyourbusiness@email.me",
        "http://www.yourbusinessnaweb.web");

    /* APPLICATION */
    PTApplication.Builder applicationBuilder = application.getApplicationBuilder("APP", "1.0",
        "My Business", "500001758", "hhtp://www.app.mybusiness.web", 1, "http://here",
        contactBuilder);
    ...
    PTCustomer.Builder customerBuilder = customer.getCustomerBuilder("Zé", "213512351", false,
    ...
    PTSupplier.Builder supplierBuilder = supplier.getSupplierBuilder("YourSupplier", "500001758",
    ...
    PTInvoiceEntity invoiceEntity = (PTInvoiceEntity) service
    ...
    service.issue(
        simpleInvoice.getSimpleInvoiceBuilder(businessEntity, SourceBilling.P, CLIENTTYPE.CUSTOMER),
        this.parameters);

    // MANUAL INVOICE
    this.parameters.setInvoiceSeries("M");
    service.issue(invoice.getManualInvoiceBuilder(businessEntity, SourceBilling.M),
        this.parameters);
    ...
    service.issue(receiptInvoice.getReceiptInvoiceBuilder(businessEntity, SourceBilling.P),
        this.parameters);
    ...
    service.issue(creditNote.getCreditNoteBuilder(invoiceEntity), this.parameters);

    this.exportSAFT(daoPTRegionContext, applicationEntity, businessEntity, daoPTCustomer,
        daoPTSupplier, daoPTTax, daoPTProduct, daoPTInvoice, daoPTSimpleInvoice,
        daoPTReceiptInvoice, daoPTCreditNote);
  }

  private void exportSAFT(DAOPTRegionContext daoPTRegionContext,
      PTApplicationEntity applicationEntity, PTBusinessEntity businessEntity,
      DAOPTCustomer daoPTCustomer, DAOPTSupplier daoPTSupplier, DAOPTTax daoPTTax,
      DAOPTProduct daoPTProduct, DAOPTInvoice daoPTInvoice, DAOPTSimpleInvoice daoPTSimpleInvoice,
      DAOPTReceiptInvoice daoPTReceiptInvoice, DAOPTCreditNote daoPTCreditNote)
      throws FileNotFoundException, SAFTPTExportException {
    ...
    generator.generateSAFTFile(stream, businessEntity, applicationEntity, "1234",
        calendar.getTime(), new Date(), SAFTVersion.V10201);

    stream = new PrintStream(SAFTExportTest.SAFT_OUTPUT + "SAFT_10301.xml");
    generator.generateSAFTFile(stream, businessEntity, applicationEntity, "1234",
        calendar.getTime(), new Date(), SAFTVersion.V10301);
  }
}
