...
public class TestPTCustomerBuilder extends PTAbstractTest {
  ...
  @Test
  public void doTest() {
    MockPTCustomerEntity mockCustomer = this.createMockEntity(MockPTCustomerEntity.class,
    ...
    Mockito.when(mockMainAddressBuilder.build())
        .thenReturn((PTAddressEntity) mockCustomer.getMainAddress());
    ...
    Mockito.when(mockBillingAddressBuilder.build())
        .thenReturn((PTAddressEntity) mockCustomer.getBillingAddress());
    ...
    Mockito.when(mockContactBuilder1.build())
        .thenReturn((PTContactEntity) mockCustomer.getContacts().get(0));

    PTContact.Builder mockContactBuilder2 = this.getMock(PTContact.Builder.class);
    Mockito.when(mockContactBuilder2.build())
        .thenReturn((PTContactEntity) mockCustomer.getContacts().get(1));
    ...
    builder.addAddress(mockMainAddressBuilder, true).addContact(mockMainContactBuilder)
        ...
        .setTaxRegistrationNumber(mockCustomer.getTaxRegistrationNumber(), PT_COUNTRY_CODE)
