...
public class PTAddressTestUtil {
    ...
    public PTAddress.Builder getAddressBuilder(String streetName, String number, String details, String building,
    ...
    public PTAddress.Builder getAddressBuilder() {
        return this.getAddressBuilder(PTAddressTestUtil.STREET, PTAddressTestUtil.NUMBER, PTAddressTestUtil.DETAILS,
                PTAddressTestUtil.BUILDING, PTAddressTestUtil.CITY, PTAddressTestUtil.POSTAL_CODE,
