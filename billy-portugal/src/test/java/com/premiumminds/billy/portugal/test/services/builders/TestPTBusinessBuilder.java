...
public class TestPTBusinessBuilder extends PTAbstractTest {
  ...
  @Test
  public void doTest() {
    MockPTBusinessEntity mockBusiness = this.createMockEntity(MockPTBusinessEntity.class,
    ...
    Mockito.when(mockMainContactBuilder.build())
        .thenReturn((PTContactEntity) mockBusiness.getMainContact());
    ...
    Mockito.when(mockAddressBuilder.build())
        .thenReturn((PTAddressEntity) mockBusiness.getAddress());
    ...
    Mockito.when(mockBillingAddressBuilder.build())
        .thenReturn((PTAddressEntity) mockBusiness.getBillingAddress());
