...
public class PTProductTestUtil {
  ...
  public PTProduct.Builder getProductBuilder(String productCode, String unitMesure,
  ...
  public PTProductEntity getProductEntity(String productCode, String unitMesure, String numberCode,
      String group, ProductType type) {
    return (PTProductEntity) this.getProductBuilder(productCode, unitMesure, numberCode, group,
