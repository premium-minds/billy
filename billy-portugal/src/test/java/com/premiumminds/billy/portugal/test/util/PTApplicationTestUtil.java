...
public class PTApplicationTestUtil {
  ...
  public PTApplication.Builder getApplicationBuilder(String appName, String version,
      String companyName, String companyTaxId, String website, Integer swCertificateNumber,
    ...
    applicationBuilder.addContact(contactBuilder).setApplicationKeysPath(new URL(keysPath))
        .setDeveloperCompanyName(companyName).setDeveloperCompanyTaxIdentifier(companyTaxId)
        .setName(appName).setSoftwareCertificationNumber(swCertificateNumber).setVersion(version)
  ...
  public PTApplication.Builder getApplicationBuilder() throws MalformedURLException {
    ...
    return this.getApplicationBuilder(PTApplicationTestUtil.APP_NAME, PTApplicationTestUtil.VERSION,
        ...
        PTApplicationTestUtil.WEBSITE, PTApplicationTestUtil.SW_CERTIFICATE_NUMBER,
