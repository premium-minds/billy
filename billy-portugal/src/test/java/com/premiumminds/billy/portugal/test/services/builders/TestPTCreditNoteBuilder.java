...
public class TestPTCreditNoteBuilder extends PTAbstractTest {
  ...
  @Test
  public void doTest() {
    MockPTCreditNoteEntity mock = this.createMockEntity(MockPTCreditNoteEntity.class,
    ...
    Mockito.when(this.getInstance(DAOPTCreditNoteEntry.class).get(Matchers.any(UID.class)))
    ...
    MockPTPaymentEntity mockPayment = this.createMockEntity(MockPTPaymentEntity.class,
        TestPTCreditNoteBuilder.PT_PAYMENT_YML);
