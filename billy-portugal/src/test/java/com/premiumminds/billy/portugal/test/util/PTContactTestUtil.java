...
public class PTContactTestUtil {
  ...
  public PTContact.Builder getContactBuilder(String name, String telephone, String mobile,
  ...
  public PTContact.Builder getContactBuilder() {
    return this.getContactBuilder(PTContactTestUtil.NAME, PTContactTestUtil.TELEPHONE,
        PTContactTestUtil.MOBILE, PTContactTestUtil.FAX, PTContactTestUtil.EMAIL,
