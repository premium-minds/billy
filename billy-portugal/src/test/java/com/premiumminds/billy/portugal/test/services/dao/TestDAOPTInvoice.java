...
public class TestDAOPTInvoice extends PTPersistencyAbstractTest {
	...
	public void testInvoiceFromBusiness() {
		...
		PTGenericInvoiceEntity res = this.getInstance(DAOPTInvoice.class).findByNumber(
	...
	public void testFindCreditNote() {
		...
		List<PTCreditNote> cn1 = this.getInstance(DAOPTCreditNote.class).findByReferencedDocument(
