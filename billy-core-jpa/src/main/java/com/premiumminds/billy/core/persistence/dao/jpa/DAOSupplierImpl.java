...
public class DAOSupplierImpl extends AbstractDAO<SupplierEntity, JPASupplierEntity>
    implements DAOSupplier {
  ...
  public List<SupplierEntity> getAllActiveSuppliers() {
    List<JPASupplierEntity> result = (List<JPASupplierEntity>) this.getEntityManager().createQuery(
