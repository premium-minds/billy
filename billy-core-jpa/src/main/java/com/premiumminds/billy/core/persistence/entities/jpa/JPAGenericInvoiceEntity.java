...
public class JPAGenericInvoiceEntity extends JPABaseEntity implements GenericInvoiceEntity {
  ...
  @OneToOne(targetEntity = JPAShippingPointEntity.class, cascade = { CascadeType.PERSIST,
      CascadeType.MERGE })
  ...
  @ElementCollection
  @CollectionTable(name = Config.TABLE_PREFIX
      + "INVOICE_RECEIPT_NUMBER", joinColumns = @JoinColumn(name = "ID_INVOICE"))
  @Column(name = "RECEIPT_NUMBER")
  protected List<String> receiptNumbers;

  @OneToMany(targetEntity = JPAGenericInvoiceEntryEntity.class, cascade = { CascadeType.PERSIST,
      CascadeType.MERGE })
  @JoinTable(name = Config.TABLE_PREFIX + "INVOICE_ENTRY", joinColumns = {
      @JoinColumn(name = "ID_INVOICE", referencedColumnName = "ID") }, inverseJoinColumns = {
          @JoinColumn(name = "ID_ENTRY", referencedColumnName = "ID", unique = true) })
  protected List<GenericInvoiceEntry> entries;

  @OneToMany(targetEntity = JPAPaymentEntity.class, cascade = { CascadeType.PERSIST,
      CascadeType.MERGE })
  @JoinTable(name = Config.TABLE_PREFIX + "PAYMENTS", joinColumns = {
      @JoinColumn(name = "ID_INVOICE", referencedColumnName = "ID") }, inverseJoinColumns = {
          @JoinColumn(name = "ID_PAYMENT", referencedColumnName = "ID", unique = true) })
