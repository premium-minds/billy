...
public class PTReceiptInvoiceData extends PTGenericInvoiceData {

    public PTReceiptInvoiceData(String number, Date date, Date settlementDate, List<PaymentData> payments,
