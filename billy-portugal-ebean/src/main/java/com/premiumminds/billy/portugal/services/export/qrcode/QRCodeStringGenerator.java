...
public class QRCodeStringGenerator {
    ...
    public QRCodeStringGenerator() {
        ...
        this.ptContexts= new PTContexts(
            ...
            this.config.getUID(Key.Context.Portugal.Continental.UUID),
            this.config.getUID(Key.Context.Portugal.Azores.UUID),
            this.config.getUID(Key.Context.Portugal.Madeira.UUID)
        );
    }
