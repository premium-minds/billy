...
public class PTSupplierTestUtil {
    ...
    public PTSupplier.Builder getSupplierBuilder(String name, String taxNumber, boolean selfBillingAgree,
            PTAddress.Builder addressBuilder, PTContact.Builder contactBuilder) {
        ...
        supplierBuilder.addAddress(addressBuilder).addContact(contactBuilder).setBillingAddress(addressBuilder)
                ...
                .setTaxRegistrationNumber(taxNumber, PTSupplierTestUtil.PT_COUNTRY_CODE).setName(name)
