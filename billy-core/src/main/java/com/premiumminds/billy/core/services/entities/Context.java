 ...
 *
 * The Billy services entity for a context.
 * A context is an aggregation concept which might represent
 * a region context, political context, financial context and so on.
 * 
 * The purpose of this entity is to create relationships between different
 * concepts.
 * For instance, a {@link Tax} entity needs a defined context over which it is
 * valid. An example would be a tax for Portugal which is only applied in a Portuguese
 * context.
 */
