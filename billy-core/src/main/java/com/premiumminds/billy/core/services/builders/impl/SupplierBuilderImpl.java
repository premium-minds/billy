...
public class SupplierBuilderImpl<TBuilder extends SupplierBuilderImpl<TBuilder, TSupplier>, TSupplier extends Supplier>
        extends AbstractBuilder<TBuilder, TSupplier> implements SupplierBuilder<TBuilder, TSupplier> {
    ...
    public TBuilder setTaxRegistrationNumber(String number, String countryCode) {
        ...
        BillyValidator.notBlank(number, SupplierBuilderImpl.LOCALIZER.getString("field.supplier_tax_number_iso_country_code"));
    ...
    public <T extends Address> TBuilder setBillingAddress(Builder<T> addressBuilder) {
        BillyValidator.notNull(addressBuilder,
                SupplierBuilderImpl.LOCALIZER.getString("field.supplier_billing_address"));
    ...
    public <T extends Address> TBuilder setShippingAddress(Builder<T> addressBuilder) {
        BillyValidator.notNull(addressBuilder,
                SupplierBuilderImpl.LOCALIZER.getString("field.supplier_shipping_address"));
