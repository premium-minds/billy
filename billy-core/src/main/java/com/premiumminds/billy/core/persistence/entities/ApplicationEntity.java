 ...
 * 
 * The definition of a Billy persistence application entity.
 * An application is the piece of software that uses Billy.
 * This is needed to identity the origin of the billing data.
 */
