...
public class BillyValidator extends Validate {
	...
	public static void validateBeans(Object... objects) throws ValidationException {
		...
		for(Object o : objects) {
			Set<ConstraintViolation<Object>> violations = instance.validator.validate(o);
	...
	public static <T> T mandatory(T o, String fieldName) {
		notNull(o, instance.localizer.getString("invalid.mandatory", fieldName), o);
		return o;
	}

	public static <T extends CharSequence> T mandatory(T o, String fieldName) {
		notNull(o, instance.localizer.getString("invalid.mandatory", fieldName), o);
		notBlank(o, instance.localizer.getString("invalid.mandatory", fieldName), o);
		return o;
	}

	public static <T> T notNull(T object, String fieldName) {
		notNull(object, instance.localizer.getString("invalid.null", fieldName), fieldName);
		return object;
	}
	
	public static <T extends CharSequence> T notBlank(T object, String fieldName) {
		notBlank(object, instance.localizer.getString("invalid.blank", fieldName), fieldName);
		return object;
	}
	
	public static <T extends Collection<?>> T notEmpty(T object, String fieldName) {
		notEmpty(object, instance.localizer.getString("invalid.empty", fieldName), fieldName);
		return object;
	}

	public static <T> T found(T o, String fieldName) {
		notNull(o, instance.localizer.getString("invalid.not_found", fieldName), o);
		return o;
	}
