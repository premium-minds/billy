...
implements BankAccountBuilder<TBuilder, TBankAccount> {
	...
	@Inject
	public BankAccountBuilderImpl(
			DAOBankAccount daoBankAccount) {
	...
	public TBuilder setIBANNumber(String iban) {
		BillyValidator.mandatory(iban, LOCALIZER.getString("field.iban"));
		getTypeInstance().setIBANNumber(iban);
		return getBuilder();
	}

	@Override
	public TBuilder setBankIdentifier(String bankId) {
		getTypeInstance().setBankIdentifier(bankId);
		return getBuilder();
	}

	@Override
	public TBuilder setBankAccountNumber(String accountNumber) {
		BillyValidator.mandatory(accountNumber, LOCALIZER.getString("field.bank_account_number"));
		getTypeInstance().setBankAccountNumber(accountNumber);
		return getBuilder();
	}
	...
	public TBuilder setOwnerName(String ownerName) {
		getTypeInstance().setOwnerName(ownerName);
		return getBuilder();
	}
	...
	protected void validateInstance()
		...
		BankAccountEntity b = getTypeInstance();
