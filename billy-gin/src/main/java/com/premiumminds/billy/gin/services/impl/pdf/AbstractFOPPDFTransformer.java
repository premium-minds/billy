...
public abstract class AbstractFOPPDFTransformer<T extends GenericInvoiceData> extends FOPPDFTransformer
        implements BillyExportTransformer<T, OutputStream> {
    ...
    public AbstractFOPPDFTransformer(Class<T> transformableClass, MathContext mc, String logoImagePath,
    ...
    protected void setEntries(TaxTotals taxTotals, ParamsTree<String, String> params, T document) {
        ...
        for (InvoiceEntryData entry : genericInvoiceList) {
            ...
            entryNode.addChild(ParamKeys.ENTRY_QUANTITY,
                    entry.getQuantity().setScale(BillyMathContext.SCALE, this.mc.getRoundingMode()).toPlainString());
    ...
    protected class TaxTotals {
        ...
        private class TaxTotalEntry {
            ...
            public TaxTotalEntry(boolean perc, BigDecimal taxValue, BigDecimal baseValue, BigDecimal appliedTaxValue,
        ...
        public void add(boolean isPercentage, BigDecimal taxValue, BigDecimal baseValue, BigDecimal taxAmount,
                String taxUid, String designation, String description) {
            TaxTotalEntry currentEntry =
                    new TaxTotalEntry(isPercentage, taxValue, baseValue, taxAmount, designation, description);
