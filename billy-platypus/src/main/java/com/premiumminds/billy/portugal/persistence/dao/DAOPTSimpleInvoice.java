...
public interface DAOPTSimpleInvoice extends DAO<IPTSimpleInvoiceEntity> {

	List<IPTSimpleInvoiceEntity> getBusinessSimpleInvoicesForSAFTPT(UUID uuid,
			Date fromDate, Date toDate);

	IPTSimpleInvoiceEntity getPTSimpleInvoiceInstance(
			IPTBusinessEntity business, BusinessOfficeEntity office,
			...
			Date deliveryDate, IPTRegionContextEntity ptRegionContextEntity);
